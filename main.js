...
function loadContact() {
  ...
  var reserveLabel = document.createElement('p');
...
function loadMenu() {
  ...
  var menuItems = [new MenuItem(images('./homeFood.png'), 'King Pao Fish', 'Savory & Spicy', 250, 4.5), new MenuItem(images('./beefPlate.png'), 'Spring Beef Platoon', 'Tangy and Wild', 700, 4.9), new MenuItem(images('./chickenSalad.png'), 'The Michael', 'Unpleasantly Good', 200, 4.0), new MenuItem(images('./homeFood.png'), "Sydney's Donut", 'Sweeping Delightful', 300, 4.4), new MenuItem(images('./homeFood.png'), 'The Chocolate Banana', 'Surprisingly simple', 800, 4.1), new MenuItem(images('./homeFood.png'), "Mikey's Spaghetti", 'Like A Can Of Whoopass', 1300, 5.0)];

  // Append each menu item to the container
  menuItems.forEach(function (item) {
    return menuContainer.appendChild(item.createMenuItem());
  });
}
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.h2HeaderDiv, .contactPDiv, .formDiv{
...
.formDiv {
    font-size: 2rem;
    color: white;
    background-color: rgba(255, 215, 215, 0.192);
    height: 20rem;
    width: auto;
    margin-right: 55px;
}
...
.form > input[type="email"] {
    ...
    border-radius: 14px;
    border: none;
}`, "",{"version":3,"sources":["webpack://./src/contact.css"],"names":[],"mappings":"AAAA;;IAEI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,WAAW;AACf;AACA;IACI,eAAe;IACf,iCAAiC;AACrC;AACA;IACI,eAAe;IACf,YAAY;IACZ,sCAAsC;AAC1C;AACA;IACI,eAAe;IACf,YAAY;IACZ,4CAA4C;IAC5C,aAAa;IACb,WAAW;IACX,kBAAkB;AACtB;AACA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,qBAAqB;;AAEzB;AACA;;IAEI,cAAc;IACd,YAAY;IACZ,mBAAmB;IACnB,YAAY;AAChB","sourcesContent":[".h2HeaderDiv, .contactPDiv, .formDiv{\n    \n    display: flex;\n    justify-content: center;\n    align-items: center;\n    width: auto;\n}\n.h2Header {\n    font-size: 4rem;\n    color: rgba(255, 255, 255, 0.877);\n}\n.contactPDiv {\n    font-size: 2rem;\n    color: white;\n    background-color: rgba(0, 0, 0, 0.555);\n}\n.formDiv {\n    font-size: 2rem;\n    color: white;\n    background-color: rgba(255, 215, 215, 0.192);\n    height: 20rem;\n    width: auto;\n    margin-right: 55px;\n}\n.contactSubmit {\n    margin-top: 2rem;\n    margin-left: 3rem;\n    box-shadow: 2px white;\n    \n}\n.form > input[type=\"text\"],\n.form > input[type=\"email\"] {\n    height: 2.5rem;\n    width: 15rem;\n    border-radius: 14px;\n    border: none;\n}"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./images/homeFood.png */ "./src/images/homeFood.png"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap);"]);
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Covered+By+Your+Grace&family=Indie+Flower&display=swap);"]);
...
}`, "",{"version":3,"sources":["webpack://./src/home.css"],"names":[],"mappings":";AAEA,iBAAiB;;;AAIjB;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,cAAc;AAClB;;;;AAIA;IACI,eAAe;IACf,kCAAkC;IAClC,iCAAiC;AACrC;AACA;IACI,yDAA8C;IAC9C,uBAAuB;IACvB,aAAa;IACb,YAAY;IACZ,+BAA+B;AACnC;AACA;IACI,yBAAyB;AAC7B;AACA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,YAAY;IACZ,WAAW;;AAEf","sourcesContent":["\n@import url('https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap');\n/* Indie Flower */\n@import url('https://fonts.googleapis.com/css2?family=Covered+By+Your+Grace&family=Indie+Flower&display=swap');\n\n\n.h1Container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    margin-top: 5%;\n}\n\n\n\n.h1Slogan {\n    font-size: 6rem;\n    font-family: Covered By Your Grace;\n    color: rgba(255, 253, 253, 0.918);\n}\n.foodimage {\n    background-image: url('./images/homeFood.png');\n    background-size: cover ;\n    height: 600px;\n    width: 600px;\n    transition: transform 0.5s ease;\n}\n.foodimage:hover {\n    transform: rotate(360deg);\n}\n.foodimageDiv {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    height: auto;\n    width: auto;\n\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
.menu-item .image {
    ...
    width: 270px;
    position: absolute;
    top: -125px; /* Move the image up by half its height */
    left: 50%; /* Center the image horizontally */
    transform: translateX(-50%); /* Adjust the image to stick out from the center */
...
.menu-item .background .border-shadow {
    border-bottom: 1px solid grey;
    box-shadow: 0 4px 2px -2px grey;
}
.menu-item .background .rating-calories {
    display: flex;
...
.caloriesText, .ratingText {
    font-size: 1.2rem;
    margin-top: 2rem;
}`, "",{"version":3,"sources":["webpack://./src/menu.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,sBAAsB;IACtB,sBAAsB;IACtB,2BAA2B;IAC3B,aAAa;IACb,yBAAyB;IACzB,YAAY;IACZ,kBAAkB;IAClB,iBAAiB;AACrB;AACA;IACI,aAAa;IACb,YAAY;IACZ,kBAAkB;IAClB,WAAW,EAAE,yCAAyC;IACtD,SAAS,EAAE,kCAAkC;IAC7C,2BAA2B,EAAE,kDAAkD;;IAE/E,UAAU,EAAE,6CAA6C;;AAE7D;AACA;IACI,aAAa;IACb,sBAAsB;IACtB,aAAa;AACjB;AACA;IACI,6BAA6B;IAC7B,+BAA+B;AACnC;AACA;IACI,aAAa;IACb,8BAA8B;AAClC;AACA;IACI,aAAa;IACb,eAAe;IACf,uBAAuB;;;AAG3B;AACA;IACI,eAAe;IACf,2BAA2B;IAC3B,SAAS;AACb;AACA;IACI,iBAAiB;IACjB,yCAAyC;IACzC,aAAa;IACb,mBAAmB;AACvB;AACA;IACI,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;AACvB;AACA;;IAEI,sBAAsB;IACtB,2BAA2B;;AAE/B;AACA;IACI,iBAAiB;AACrB;AACA;IACI,iBAAiB;IACjB,gBAAgB;AACpB","sourcesContent":[".menu-item {\n    display: flex;\n    flex-direction: column;\n    border: 1px solid #ccc;\n    margin: 60px 10px 10px 10px;\n    padding: 10px;\n    background-color: #f9f9f9;\n    width: 28rem;\n    position: relative;\n    margin-top: 150px;\n}\n.menu-item .image {\n    height: 270px;\n    width: 270px;\n    position: absolute;\n    top: -125px; /* Move the image up by half its height */\n    left: 50%; /* Center the image horizontally */\n    transform: translateX(-50%); /* Adjust the image to stick out from the center */\n    \n    z-index: 1; /* Ensure the image is above other elements */\n    \n}\n.menu-item .background {\n    display: flex;\n    flex-direction: column;\n    padding: 10px;\n}\n.menu-item .background .border-shadow {\n    border-bottom: 1px solid grey;\n    box-shadow: 0 4px 2px -2px grey;\n}\n.menu-item .background .rating-calories {\n    display: flex;\n    justify-content: space-between;\n}\n.menuContainer {\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: center;\n    \n\n}\n.menuTitle {\n    font-size: 2rem;\n    font-family: Homemade Apple;\n    margin: 0;\n}\n.menuDescription {\n    font-size: 1.3rem;\n    font-family: Arial, Helvetica, sans-serif;\n    margin-top: 0;\n    margin-bottom: 40px;\n}\n.titleAndDescriptionDiv {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n}\n.image {\n    \n    background-size: cover;\n    background-position: center;\n\n}\n.background {\n    margin-top: 150px;\n}\n.caloriesText, .ratingText {\n    font-size: 1.2rem;\n    margin-top: 2rem;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./images/whiteRest.png */ "./src/images/whiteRest.png"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
...
button {
    background-color: #47474785; /* Ensure buttons have a solid background color */
    border: none;
    padding: 10px 20px;
    cursor: pointer;
    z-index: 4; /* Ensure buttons are above the header */
    border-radius: 10px 34px 12px 19px;
    -webkit-border-radius: 10px 34px 12px 19px;
    -moz-border-radius: 10px 34px 12px 19px;
    height: 2rem;
    width: 12rem;
    font-size: 1.8rem;
    font-family: 'Homemade Apple';
...
button:hover {
    background-color: rgba(148, 143, 143, 0.733);
}
...
.menuBody {
    ...
    justify-content: center;
    align-items: center;
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":";AAMA;IACI,yBAAyB;IACzB,YAAY;IACZ,WAAW;;;AAGf;AACA;IACI,kBAAkB;IAClB,YAAY;IACZ,YAAY;IACZ,UAAU;AACd;AACA;IACI,WAAW;IACX,kBAAkB;IAClB,MAAM;IACN,OAAO;IACP,YAAY;IACZ,YAAY;IACZ,yDAA+C;IAC/C,4BAA4B;IAC5B,sBAAsB;IACtB,2BAA2B;IAC3B,6BAA6B;IAC7B,WAAW,EAAE,oCAAoC;AACrD;AACA;IACI,UAAU;AACd;AACA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,aAAa;IACb,uBAAuB;IACvB,gBAAgB;IAChB,UAAU;IACV,aAAa;AACjB;AACA;IACI,aAAa;IACb,YAAY;;;AAGhB;AACA;IACI,aAAa;IACb,SAAS;IACT,kBAAkB;IAClB,UAAU;IACV,WAAW;IACX,iBAAiB;IACjB,eAAe;;AAEnB;AACA;IACI,2BAA2B,EAAE,iDAAiD;IAC9E,YAAY;IACZ,kBAAkB;IAClB,eAAe;IACf,UAAU,EAAE,wCAAwC;IACpD,kCAAkC;IAClC,0CAA0C;IAC1C,uCAAuC;IACvC,YAAY;IACZ,YAAY;IACZ,iBAAiB;IACjB,6BAA6B;IAC7B,yBAAyB;IACzB,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,sCAAsC;;AAE1C;AACA;IACI,4CAA4C;AAChD;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,2BAA2B;;;AAG/B;AACA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB","sourcesContent":["\n@import url('https://fonts.googleapis.com/css2?family=Homemade+Apple&display=swap');\n\n\n\n\nbody {\n    background-color: #F8F6F0;\n    padding: 0px;\n    margin: 0px;\n\n    \n}\n.backgroundImage {\n    position: relative;\n    width: 100vw;\n    height: 100%;\n    z-index: 1;\n}\n.backgroundImage::before {\n    content: '';\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100vw;\n    height: 100%;\n    background-image: url('./images/whiteRest.png');\n    background-repeat: no-repeat;\n    background-size: cover;\n    background-position: center;\n    /* Adjust the opacity value */\n    z-index: -1; /* Ensure it is behind the content */\n}\n.above {\n    z-index: 2;\n}\nheader {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    height: 15rem;\n    background-color: black;\n    padding: 0 10rem;\n    z-index: 3;\n    opacity: 0.40;\n}\n.logo {\n    height: 12rem;\n    width: 15rem;\n\n\n}\nnav {\n    display: flex;\n    gap: 15px;\n    position: absolute;\n    top: 200px;\n    left: 250px;\n    margin-left: 20px;\n    margin-top: 5px;\n    \n}\nbutton {\n    background-color: #47474785; /* Ensure buttons have a solid background color */\n    border: none;\n    padding: 10px 20px;\n    cursor: pointer;\n    z-index: 4; /* Ensure buttons are above the header */\n    border-radius: 10px 34px 12px 19px;\n    -webkit-border-radius: 10px 34px 12px 19px;\n    -moz-border-radius: 10px 34px 12px 19px;\n    height: 2rem;\n    width: 12rem;\n    font-size: 1.8rem;\n    font-family: 'Homemade Apple';\n    color: rgb(250, 250, 250);\n    display: flex; \n    align-items: center;\n    justify-content: center;\n    transition: background-color 0.3s ease;\n    \n}\nbutton:hover {\n    background-color: rgba(148, 143, 143, 0.733);\n}\n\n#content {\n    width: 80vw;\n    height: 100%;\n    background-color: #4747476e;\n   \n    \n}\n.menuBody {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
if (true) {
  ...
  return true;
    ...
    module.hot.accept(
      /*! !!../node_modules/css-loader/dist/cjs.js!./contact.css */ "./node_modules/css-loader/dist/cjs.js!./src/contact.css",
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _node_modules_css_loader_dist_cjs_js_contact_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./contact.css */ "./node_modules/css-loader/dist/cjs.js!./src/contact.css");
(function () {
...
if (true) {
  ...
  return true;
    ...
    module.hot.accept(
      ...
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _node_modules_css_loader_dist_cjs_js_home_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./home.css */ "./node_modules/css-loader/dist/cjs.js!./src/home.css");
(function () {
...
if (true) {
  ...
  return true;
    ...
    module.hot.accept(
      /*! !!../node_modules/css-loader/dist/cjs.js!./menu.css */ "./node_modules/css-loader/dist/cjs.js!./src/menu.css",
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _node_modules_css_loader_dist_cjs_js_menu_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./menu.css */ "./node_modules/css-loader/dist/cjs.js!./src/menu.css");
(function () {
...
var map = {
	"./Designer.png": "./src/images/Designer.png",
	"./beefPlate.png": "./src/images/beefPlate.png",
	"./chickenSalad.png": "./src/images/chickenSalad.png",
	"./homeFood.png": "./src/images/homeFood.png",
	"./theBearLogo.jpg": "./src/images/theBearLogo.jpg",
	"./whiteRest.png": "./src/images/whiteRest.png"
};
...
"use strict";
module.exports = __webpack_require__.p + "6d49864a5d43ab0c5d38.png";

/***/ }),

/***/ "./src/images/beefPlate.png":
/*!**********************************!*\
  !*** ./src/images/beefPlate.png ***!
  \**********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "8f04649645198e35b969.png";

/***/ }),

/***/ "./src/images/chickenSalad.png":
/*!*************************************!*\
  !*** ./src/images/chickenSalad.png ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "68605f0067597414680e.png";

/***/ }),

/***/ "./src/images/homeFood.png":
/*!*********************************!*\
  !*** ./src/images/homeFood.png ***!
  \*********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "324f1a44e47623463258.png";

/***/ }),

/***/ "./src/images/theBearLogo.jpg":
/*!************************************!*\
  !*** ./src/images/theBearLogo.jpg ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "f3e00c8713b978945453.jpg";

/***/ }),

/***/ "./src/images/whiteRest.png":
/*!**********************************!*\
  !*** ./src/images/whiteRest.png ***!
  \**********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "9a872e67965ba8aaa540.png";
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("32f3c9fdf0784a836c29")
/******/ 	})();
/******/ 	
